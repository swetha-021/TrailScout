...
This is a portfolio project aimed at outdoor recreation software: maps, real-world conditions, and AI used as a summary layer
...
5. Writes a 3–4 sentence brief that comes from gpt-4o-mini with the forecast JSON as the only input
